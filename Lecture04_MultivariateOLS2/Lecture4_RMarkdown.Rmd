...
Now, suppose that we have data on geography (US Regions) and time (surey strata). What if Medicaid policy differed across these regions in ways that are correlated with health? Why might this be true?
