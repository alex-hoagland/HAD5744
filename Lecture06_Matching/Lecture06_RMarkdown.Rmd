...
# first, simple regression -- what is effect of insurance on poor health? 
...
Using this adjustment changes the ATE a bit, but still significant and positive. But do we think we have we dealt with all the selection? 
...
mymatches_nn <- matchit(myformula, # what to match on
                     data=mydata, # where to match
                     ...
                     ratio=1, # how many matches are we looking for?
