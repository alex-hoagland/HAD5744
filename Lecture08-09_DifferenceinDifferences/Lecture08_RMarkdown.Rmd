...
dte <- feols(logy ~ i(reltime, state, ref = -1) | location + date, data = regdata_dte)
...
dte2 <- feols(logy ~ i(reltime, state, ref = -1) | location + date, data = regdata_dte)
